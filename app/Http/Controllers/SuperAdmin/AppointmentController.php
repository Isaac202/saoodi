...
class AppointmentController extends Controller
{
    ...
    public function createAppointment($id)
    {
        ...
        return view('superAdmin.appointment.create_appointment',compact('patient','doctor','hospitals','date','patient_addressess','timeslots'));
    ...
    public function editAppointment($id)
    {
        ...
        $timeslots = (new CustomController)->timeSlot($doctor->id,$date);
        return view('superAdmin.appointment.edit_appointment',compact('appointment','hospitals','patient_addressess','date','timeslots','patient'));
    }
