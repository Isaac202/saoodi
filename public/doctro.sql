...
CREATE TABLE `settings` (
  ...
  `company_white_logo` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `website_color` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `stripe_public_key` text COLLATE utf8mb4_unicode_ci,
  `stripe_secret_key` text COLLATE utf8mb4_unicode_ci,
  `paypal_sandbox_key` text COLLATE utf8mb4_unicode_ci,
  `paypal_producation_key` text COLLATE utf8mb4_unicode_ci,
  `paypal_secret_key` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `paypal_client_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `razor_key` text COLLATE utf8mb4_unicode_ci,
  `flutterwave_key` text COLLATE utf8mb4_unicode_ci,
  `flutterwave_encryption_key` text COLLATE utf8mb4_unicode_ci,
  ...
  `default_base_on` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `mail_from_name` text COLLATE utf8mb4_unicode_ci,
  `cancel_reason` text COLLATE utf8mb4_unicode_ci,
  `radius` int(11) NOT NULL DEFAULT '50',
  `clinic_content` text COLLATE utf8mb4_unicode_ci,
  `doctor_content` text COLLATE utf8mb4_unicode_ci,
  `footer_content` text COLLATE utf8mb4_unicode_ci,
  `doctor_mail` text COLLATE utf8mb4_unicode_ci,
  `patient_mail` text COLLATE utf8mb4_unicode_ci,
  `patient_notification` text COLLATE utf8mb4_unicode_ci,
  `doctor_notification` text COLLATE utf8mb4_unicode_ci,
  `patient_app_id` text COLLATE utf8mb4_unicode_ci,
  `patient_auth_key` text COLLATE utf8mb4_unicode_ci,
  `patient_api_key` text COLLATE utf8mb4_unicode_ci,
  `doctor_app_id` text COLLATE utf8mb4_unicode_ci,
  `doctor_auth_key` text COLLATE utf8mb4_unicode_ci,
  `doctor_api_key` text COLLATE utf8mb4_unicode_ci,
  ...
  `auto_cancel` text COLLATE utf8mb4_unicode_ci,
  `playstore` text COLLATE utf8mb4_unicode_ci,
  `appstore` text COLLATE utf8mb4_unicode_ci,
...
ALTER TABLE `pharamacy_settle`
  ...
  ADD CONSTRAINT `fk_settle_pharamacy_id` FOREIGN KEY (`pharamacy_id`) REFERENCES `pharamacy` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `pharamacy_working_hour`
--
ALTER TABLE `pharamacy_working_hour`
  ADD CONSTRAINT `fk_pharamcy_working` FOREIGN KEY (`pharamacy_id`) REFERENCES `pharamacy` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `purchase_medicine`
  ...
  ADD CONSTRAINT `fk_pharamacy_id` FOREIGN KEY (`pharmacy_id`) REFERENCES `pharamacy` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
