                    ...
                    <div class="col-lg-6  h-100">
                        <div class="footer-ban-text h-100 d-flex">
                            <div class="my-auto">
                                ...
                                <p>{{ __('Get in touch with the top-most expert Specialist Doctors for an accurate consultation on the '.$setting->business_name.'. Connect with Doctors, that will be available 24/7 right for you.') }}</p>
