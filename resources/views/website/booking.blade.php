                                    ...
                                    <div id="step1" class="disp-block">
                                        <div class="appointment-form">
                                            ...
                                            <div class="pb-4">
                                                <div class="row g-2">
                                                    <div class="col-md">
                                                        <label for="" class="form-label mb-1">{{__('Hospital')}}</label>
                                        ...
                                        <div class="d-flex ">
                                            <div class="todays_slot mx-auto">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="datepicker form-control @error('date') is-invalid @enderror" id="date"  value="{{ old('date',$date) }}" min="{{ Carbon\Carbon::now(env('timezone'))->format('Y-m-d') }}"  name="date">
