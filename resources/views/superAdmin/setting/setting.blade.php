                ...
                <div class="card-body">
                    <ul class="nav nav-tabs">
                        ...
                        <li class="nav-item"><a class="nav-link active" href="#solid-justified-tab1"
                                data-toggle="tab">{{__('General Settings')}}</a></li>
                        <li class="nav-item"><a class="nav-link" href="#solid-justified-tab2"
                                data-toggle="tab">{{__('Payment setting')}}</a></li>
                        <li class="nav-item"><a class="nav-link" href="#solid-justified-tab3"
                                data-toggle="tab">{{__('verification')}}</a></li>
                        <li class="nav-item"><a class="nav-link" href="#solid-justified-tab5"
                                data-toggle="tab">{{__('Website Setting')}}</a></li>
                        <li class="nav-item"><a class="nav-link" href="#solid-justified-tab6"
                                data-toggle="tab">{{__('Notification Setting')}}</a></li>
                        <li class="nav-item"><a class="nav-link" href="#solid-justified-tab8"
                                data-toggle="tab">{{__('Static Pages')}}</a></li>
                        <li class="nav-item"><a class="nav-link" href="#solid-justified-tab9"
                                data-toggle="tab">{{__('Video Call Setting')}}</a></li>
                        @endif
                        <li class="nav-item"><a class="nav-link {{ $setting->license_verify == 0 ? 'active' : ''  }}"
                                href="#solid-justified-tab7" data-toggle="tab">{{__('License Setting')}}</a></li>
                    </ul>
                    <div class="tab-content mt-3">
                                            ...
                                            <tr>
                                                <td>
                                                    <input type="text" name="cancel_reason[]"
                                                        value="{{ $cancel_reason }}" class="form-control" required>
                                                </td>
                                                @if ($loop->iteration != 1)
                                                <td>
                        ...
                        <div class="tab-pane" id="solid-justified-tab2">
                            <form action="{{url('update_payment_setting')}}" method="POST"
                                enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-md-2">
                                        ...
                                        <label class="cursor-pointer">
                                            <input type="checkbox" name="cod" class="custom-switch-input" value="1" {{
                                                $setting->cod == 1 ? 'checked' : '' }}>
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <label class="cursor-pointer">
                                            <input type="checkbox" name="paypal" class="custom-switch-input" value="1"
                                                {{ $setting->paypal == 1 ? 'checked' : '' }}>
                                            <span class="custom-switch-indicator"></span>
                                        </label>
                                    </div>
                                    <div class="col-md-2">
                                        ...
                                        <label class="cursor-pointer">
                                            <input type="checkbox" name="stripe" class="custom-switch-input" value="1"
                                                {{ $setting->stripe == 1 ? 'checked' : '' }}>
                                            <span class="custom-switch-indicator"></span>
                                        </label>
                                    </div>
                                    <div class="col-md-2">
                                        ...
                                        <label class="cursor-pointer">
                                            <input type="checkbox" name="razor" class="custom-switch-input" value="1" {{
                                                $setting->razor == 1 ? 'checked' : '' }}>
                                            <span class="custom-switch-indicator"></span>
                                        </label>
                                    </div>
                                    <div class="col-md-2">
                                        ...
                                        <label class="cursor-pointer">
                                            <input type="checkbox" name="flutterwave" class="custom-switch-input"
                                                value="1" {{ $setting->flutterwave == 1 ? 'checked' : '' }}>
                                            <span class="custom-switch-indicator"></span>
                                        </label>
                                    </div>
                                    <div class="col-md-2">
                                        ...
                                        <label class="cursor-pointer">
                                            <input type="checkbox" name="paystack" class="custom-switch-input" value="1"
                                                {{ $setting->paystack == 1 ? 'checked' : '' }}>
                                            <span class="custom-switch-indicator"></span>
                                        </label>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <a href="https://stripe.com/docs/keys#obtain-api-keys" target="_blank" class=""
                                        data-toggle="tooltip" data-placement="top" title="Help">
                                        <i class="fa fa-info-circle" aria-hidden="true"></i>
                                    </a>
                                    <input type="text" value="{{ $setting->stripe_public_key }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ $setting->stripe_secret_key }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ $setting->paypal_sandbox_key }}"
                                        name="paypal_sandbox_key"
                                        class="form-control @error('paypal_sandbox_key') is-invalid @enderror">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ $setting->paypal_producation_key }}"
                                        name="paypal_producation_key"
                                        class="form-control @error('paypal_producation_key') is-invalid @enderror">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ $setting->paypal_client_id }}" name="paypal_client_id"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ $setting->flutterwave_key }}" name="flutterwave_key"
                                        class="form-control @error('flutterwave_key') is-invalid @enderror">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ $setting->flutterwave_encryption_key }}"
                                        ...
                                        class="form-control @error('flutterwave_encryption_key') is-invalid @enderror">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ $setting->paystack_public_key }}"
                        ...
                        <div class="tab-pane" id="solid-justified-tab3">
                            <form action="{{url('update_verification_setting')}}" method="POST"
                                enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-md-4 form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ $setting->twilio_acc_id }}" name="twilio_acc_id"
                                        class="form-control @error('twilio_acc_id') is-invalid @enderror">
                                    @error('twilio_acc_id')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="tab-pane" id="solid-justified-tab5">
                            <form action="{{url('update_content')}}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <label for="app_id" class="col-form-label"> {{__('Website Banner
                                            Image')}}</label>
                                        <div class="avatar-upload avatar-box avatar-box-left">
                                            <div class="avatar-edit">
                                                <input type='file' id="image4" name="banner_image"
                                                    accept=".png, .jpg, .jpeg" />
                                                <label for="image4"></label>
                                            </div>
                                            <div class="avatar-preview">
                                                <div id="imagePreview4"
                                                    style="background-image: url({{ 'images/upload/'.$setting->banner_image }});">
                                                </div>
                                            </div>
                                        </div>
                                        @error('banner_image')
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="url" name="playstore" required
                                        class="form-control @error('playstore') is-invalid @enderror"
                                        value="{{ $setting->playstore }}">
                                    @error('playstore')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="url" name="appstore" required
                                        class="form-control @error('appstore') is-invalid @enderror"
                            ...
                            <form action="{{url('update_notification')}}" method="POST">
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        ...
                                        <label class="cursor-pointer">
                                            <input type="checkbox" name="patient_mail" class="custom-switch-input"
                                                value="1" {{ $setting->patient_mail == 1 ? 'checked' : '' }}>
                                            <span class="custom-switch-indicator"></span>
                                        </label>
                                    </div>
                                    <div class="col-md-3">
                                        ...
                                        <label class="cursor-pointer">
                                            <input type="checkbox" name="doctor_mail" class="custom-switch-input"
                                                value="1" {{ $setting->doctor_mail == 1 ? 'checked' : '' }}>
                                            <span class="custom-switch-indicator"></span>
                                        </label>
                                    </div>
                                    <div class="col-md-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ $setting->patient_app_id }}" name="patient_app_id"
                                        class="form-control @error('patient_app_id') is-invalid @enderror">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ $setting->patient_auth_key }}" name="patient_auth_key"
                                        class="form-control @error('patient_auth_key') is-invalid @enderror">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ $setting->patient_api_key }}" name="patient_api_key"
                                        class="form-control @error('patient_api_key') is-invalid @enderror">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ $setting->doctor_app_id }}" name="doctor_app_id"
                                        class="form-control @error('doctor_app_id') is-invalid @enderror">
                                    @error('doctor_app_id')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ $setting->doctor_auth_key }}" name="doctor_auth_key"
                                        class="form-control @error('doctor_auth_key') is-invalid @enderror">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ $setting->doctor_api_key }}" name="doctor_api_key"
                                        class="form-control @error('doctor_api_key') is-invalid @enderror">
                            ...
                            <form action="{{url('update_video_call_setting')}}" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="agora_app_id"
                                        class="form-control @error('agora_app_id') is-invalid @enderror"
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="agora_app_certificate"
                                        class="form-control @error('agora_app_certificate') is-invalid @enderror"
                        ...
                        <div class="tab-pane {{ $setting->license_verify == 0 ? ' show active' : ''  }}"
                            ...
                            <form action="{{url('update_licence_setting')}}" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    value="{{ $setting->license_code }}" name="license_code" class="form-control
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" required {{ $setting->license_verify == 1 ? 'disabled' : '' }}
                                    value="{{ $setting->client_name }}" name="client_name" class="form-control
